...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	...
	<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/hotel2.jpeg');"
		...
		<div class="container">
			<div class="row justify-content-center pb-4">
				<div class="col-md-12 heading-section text-center ftco-animate">
					<h2 class="mb-4" id="destinations" style="color: #f9ab30; padding-top: 50px;">Nos Destinations</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-12 ftco-animate">
					<div class="project-destination">
						<span class="img" style="background-image: url(images/pictures/pic2.jpeg);">
							<div class="text btn-group">
								...
								<span class="dropup">
									...
									<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
										<button class="dropdown-item" type="button"><a href="circuit1.php">Circuit de la légende sud</a></button>
										<button class="dropdown-item" type="button"><a href="circuit2.php">Circuit de la légende nord</a></button>
									</div>
								</span>
							</div>
						</span>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 ftco-animate">
					<div class="project-destination">
						<span class="img" style="background-image: url(images/pictures/turquie.jpeg);">
							<div class="text">
								<h3>Turquie</h3>
							</div>
						</span>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 ftco-animate">
					<div class="project-destination">
						<span class="img" style="background-image: url(images/pictures/egypt.jpeg);">
							<div class="text">
								<h3>Egypte</h3>
							</div>
						</span>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 ftco-animate">
					<div class="project-destination">
						<span class="img" style="background-image: url(images/pictures/Indonesie.jpeg);">
							<div class="text">
								<h3>Indonésie</h3>
							</div>
						</span>
