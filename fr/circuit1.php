...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/circuit1.jpeg');"
    ...
    <section class="ftco-section ftco-no-pt" id="circuit1">
        ...
        <div class="container py-2">
            ...
            <div class="row no-gutters align-items-center">
                <div class="col-sm">
                    ...
                    <div class="slideshow-container">
                        ...
                        <div class="fade">
                            <img class=" rounded mx-auto d-block shadow" src="images/pictures/pic2.jpeg"
                                style="width:100%">
                            <div class="text">Djerba</div>
                        </div>
                    </div>
            ...
            <div class="row no-gutters align-items-center">
                <div class="col-sm py-2">
                    <div class="card shadow">
                        <div class="card-body">
                            <h4 class="card-title" style="color: #f4a72e;">Day 2</h4>
                            <p class="card-text">Djerba Tataouine</p>


                            <button class="btn btn-sm btn-outline-secondary" type="button" data-target="#t2_details"
                                data-toggle="collapse">Details ▼</button>
                ...
                <div class="col-sm">
                    ...
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides2 fade">
                            ...
                            <img class=" rounded mx-auto d-block shadow" src="images/pictures/Chenini-Tataouine-2.jpg"
                                style="width:100%">
                            <div class="text">Chenini Tataouine</div>
                        </div>
            ...
            <div class="row no-gutters align-items-center">
                <div class="col-sm">
                    ...
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides3 fade">
                            <img class=" rounded mx-auto d-block shadow" src="images/pictures/pic5.jpg"
                                style="width:100%">
                            <div class="text">Ksar Ghilaine</div>
                        </div>
                ...
                <div class="col-sm py-2">
                    <div class="card shadow">
                        <div class="card-body">
                            <h4 class="card-title" style="color: #f4a72e;">Day 3</h4>
            ...
            <div class="row no-gutters align-items-center">
                <div class="col-sm py-2">
                    <div class="card shadow">
                        <div class="card-body">
                            <h4 class="card-title" style="color: #f4a72e;">Day 4</h4>
                ...
                <div class="col-sm">
                    ...
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides4 fade">
                            ...
                            <img class=" rounded mx-auto d-block shadow" src="images/pictures/pic4.jpg"
                                style="width:100%">
                            <div class="text">Chott el Jerid</div>
                        </div>

                        <div class="mySlides4 fade">
                            <div class="numbertext">2 / 2</div>
                            <img class=" rounded mx-auto d-block shadow"
                                src="images/pictures/Canyons-de-Midès-–-Tozeur.jpg" style="width:100%">
                            <div class="text">Canyons de Midès, Tozeur</div>
                        </div>
            ...
            <div class="row no-gutters align-items-center">
                <div class="col-sm">
                    ...
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides5 fade">
                            <img class=" rounded mx-auto d-block shadow"
                                src="images/pictures/Matmata-Underground-Home-with-Mountain-View-From-Above.jpg"
                                style="width:100%">
                            <div class="text">Hôtel Diar el Barber</div>
                        </div>
                ...
                <div class="col-sm py-2">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <h4 class="card-title" style="color: #f4a72e;">Day 5</h4>
            ...
            <div class="row no-gutters align-items-center">
                <div class="col-sm py-2">
                    <div class="card shadow">
                        <div class="card-body">
                            <h4 class="card-title" style="color: #f4a72e;">Day 6</h4>
                ...
                <div class="col-sm">
                    ...
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                            <img class=" rounded mx-auto d-block shadow" src="images/pictures/toujane.jpg"
                                style="width:100%">
                            <div class="text">Toujane</div>
                        </div>
