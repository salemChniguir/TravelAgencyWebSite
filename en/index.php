...
<body>
	...
	<div class="js-fullwidth"
		style="background-image: url('images/accueil.jpeg');background-repeat:no-repeat;  background-attachment: fixed;background-size: cover;"
					...
					<div id="carousel-example-1" class="carousel slide carousel-fade z-depth-1-half"
						...
						<div class="carousel-inner" role="listbox">
							<div class="carousel-item active">
								<div class="view">
									<img class="d-block w-100" src="images/pictures/Canyons-de-Midès-–-Tozeur.jpg"
										alt="Tozeur">
									<div class="mask rgba-black-light"></div>
								</div>
								<div class="carousel-caption">
									<h3 class="h3-responsive"
										style="color: #00BFFF; font-size: xx-large; font-weight: bold;">Tozeur</h3>
							...
							<div class="carousel-item">
								<!--Mask color-->
								<div class="view">
									<img class="d-block w-100" src="images/pictures/klibia.jpg" alt="Second slide">
									<div class="mask rgba-black-light"></div>
								</div>
								<div class="carousel-caption">
									<h3 class="h3-responsive"
										style="color: #00BFFF; font-size: xx-large; font-weight: bold;">Klibia</h3>
							...
							<div class="carousel-item">
								<!--Mask color-->
								<div class="view">
									<img class="d-block w-100" src="images/pictures/takelsa.jpg" alt="Third slide">
									<div class="mask rgba-black-light"></div>
								</div>
								<div class="carousel-caption">
									<h3 class="h3-responsive"
										style="color: #00BFFF; font-size: xx-large; font-weight: bold;">Takelsa</h3>
							...
							<div class="carousel-item">
								<!--Mask color-->
								<div class="view">
									<img class="d-block w-100" src="images/pictures/pic5.jpg" alt="Third slide">
									<div class="mask rgba-black-light"></div>
								</div>
								<div class="carousel-caption">
									<h3 class="h3-responsive"
							...
							<div class="carousel-item">
								<!--Mask color-->
								<div class="view">
									<img class="d-block w-100" src="images/pictures/site-archéologique-Oudna.jpg"
										alt="Third slide">
									<div class="mask rgba-black-light"></div>
								</div>
								<div class="carousel-caption">
									<h3 class="h3-responsive"
										style="color: #00BFFF; font-size: xx-large; font-weight: bold;">Site
										Archéologique Oudna</h3>
							...
							<div class="carousel-item">
								<!--Mask color-->
								<div class="view">
									<img class="d-block w-100" src="images/pictures/Plage-dEl-Haouaria.jpg"
										alt="Third slide">
									<div class="mask rgba-black-light"></div>
								</div>
								<div class="carousel-caption">
									<h3 class="h3-responsive"
										style="color: #f9ab30; font-size: xx-large; font-weight: bold;">Plage dEl
										Haouaria</h3>
					...
					<div class="block-23 mb-3">
						<ul class="nav navbar navbar-left d-flex d-inline-flex ">
							<li><span class="icon icon-map-marker"></span><span class="text">11 Cité Sidi bechir, 4180,
									Houmet Souk, Djerba, Tunisia</span></li>
